...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('siteparser_core_path', null,
                    $modx->getOption('core_path') . 'components/siteparser/') . 'model/';
            $modx->addPackage('siteparser', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/siteparser/model/schema/siteparser.mysql.schema.xml';
